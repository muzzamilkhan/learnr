 ...
 *
 * Applied where the child's own IP is visible - the web app's server action.
 * Ten is far more than a child mistyping a four-character code needs and far
 * less than a guesser wants.
 */
